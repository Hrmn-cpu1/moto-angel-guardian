...
/**
 * Síntese de voz nativa da DAISY.
 *
 * A WebView não garante speechSynthesis no APK. Esta ponte usa o motor TTS
 * instalado no Android e mantém o fallback web para o navegador.
 */
